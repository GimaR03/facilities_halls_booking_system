...
export default function LLoginView({
  clearMessages,
  setCurrentDashboard,
  loginForm,
  setLoginForm,
          ...
          <div className="workspace-grid auth-layout">
            <aside className="auth-showcase glass-panel">
              <div className="auth-showcase-copy">
                ...
                <p>
                  Sign in to manage hall reservations, view requests, and keep your day
            ...
            <div className="auth-panel-shell">
              <form className="glass-panel auth-panel auth-login-panel" onSubmit={handleLoginSubmit}>
                <div className="auth-form-head">
                  ...
                  <p>Use your account details below and pick up right where you left off.</p>
                </div>
