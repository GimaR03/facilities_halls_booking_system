...
export default function LRegisterView({
  clearMessages,
  setCurrentDashboard,
  registerForm,
  setRegisterForm,
          ...
          <div className="register-experience">
            <form className="register-form-surface" onSubmit={handleRegisterSubmit}>
              <div className="register-form-top">
                ...
                <p>
                  The registration page is designed as a guided onboarding form so each
                  section feels easier to understand and complete.
                </p>
              </div>
              ...
              <div className="register-section-grid">
                ...
                <section className="register-card">
                  ...
                  <div className="register-inline-note">
                    ...
                    <p>
                      Accurate department and affiliation details make approvals, bookings,
                      and support flows easier later.
                    </p>
                  </div>
                </section>
              ...
              <div className="register-actions-bar">
                ...
                <div className="auth-mini-note register-mini-note">
                  ...
                  <p>
                    ...
                    to sign in with your new details.
                  </p>
                </div>
              </div>
            </form>
            ...
            <aside className="register-sidebar">
              ...
              <div className="register-benefit-card glass-panel">
                ...
                <p>
                  Login should be quick. Registration should feel guided. This version
                  separates setup into clearer stages so new users are less likely to feel
                  lost.
                </p>
